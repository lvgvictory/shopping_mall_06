{{-- admin/pages/subcategories/search.blade.php --}}
...
<div class="row">
   ...
   {{-- end search --}}
   <div class="col-lg-12">
      <h3>{{ trans('list_category_admin.result') }} {{ count($subCate) }}</h3>
   </div>
   <div class="col-lg-12">
      <ol class="breadcrumb">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  ...
                  <div class="btn-group">
                     <form method="POST" action="{{ route("sub-category.destroy", $subCate->id) }}">
                     {{ method_field("DELETE")}}
                     {{ csrf_field() }}
