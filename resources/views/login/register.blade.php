                                ...
                                <div class="mt-4">
                                    <form>
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="name" value="" placeholder="Fullname">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="phone" value="" placeholder="Your telephone">
                                        </div>
                                        <div class="form-group">
										...
										<div class="form-group">
                                            <input type="password" class="form-control" id="password-confirm" value="" placeholder="Password confirm">
                                        </div>
